      ...
      <div class="row">
        ...
        <div class="col-6 col-md">
          ...
          <ul class="list-unstyled text-small">
            <li><a class="text-muted" href="#">Banquet | Lawn</a></li>
            <li><a class="text-muted" href="#">Catering</a></li>
            <li><a class="text-muted" href="#">Rent a Car</a></li>
            <li><a class="text-muted" href="#">Inviation Cards</a></li>
            <li><a class="text-muted" href="#">Dress Designer</a></li>
            <li><a class="text-muted" href="#">Make Over</a></li>
          </ul>
        </div>
        <div class="col-6 col-md">
          <h5>Features</h5>
